...
If a user doesn't have a node of their own then the public gateway C<https://dweb.link>
is used by default.
...
and C<$HOME/.ipfs/>, in that order. If that fails C<https://dweb.link> will be used.
