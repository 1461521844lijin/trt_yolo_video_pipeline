...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-libx264 --prefix=/usr/local/ffmpeg-build --enable-shared"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "/usr/local/ffmpeg-build/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/ffmpeg-build/share/ffmpeg"
